...
Set plateAPrimerRange = Sheet10.Range("D4:D99")
Set listAPrimerRange = Sheet1.Range("D4:D99")
Set plateASampleRange = Sheet10.Range("B4:B99")
Set listASampleRange = Sheet1.Range("B4:B99")
...
If numOfPrimerPlate > 0 Then
    Do Until primerCounter > numOfPrimerPlate
            ...
            Do Until arrayCounter > arrayPosition
                If primerArray(arrayCounter) = Sheet10.Range("D" & positionCounter) Then
                    arrayBoolean = 1
                End If
        ...
        If arrayBoolean = 0 Then
            primerArray(arrayPosition) = Sheet10.Range("D" & positionCounter)
            arrayPosition = arrayPosition + 1
        End If
    If Sheet10.Range("D" & positionCounter) <> "" Then
...
Do Until primerCounter > numOfPrimerList
            ...
            Do Until arrayCounter > arrayPosition
                If primerArray(arrayCounter) = Sheet1.Range("D" & positionCounter) Then
                    arrayBoolean = 1
                End If
                arrayCounter = arrayCounter + 1
             Loop
        ...
        If arrayBoolean = 0 Then
            primerArray(arrayPosition) = Sheet1.Range("D" & positionCounter)
            arrayPosition = arrayPosition + 1
        End If
    If Sheet1.Range("D" & positionCounter) <> "" Then
        primerCounter = primerCounter + 1
    End If
...
Sheet2.Range("B28") = arrayPosition
Sheet2.Range("B30") = primerArray(0)
Sheet2.Range("E30") = primerArray(1)
Sheet2.Range("H30") = primerArray(2)
Sheet2.Range("K30") = primerArray(3)
